...
class _Template extends Template {
  const _Template({required this.id, required this.language, required this.title, required this.markdownText, required this.createdBy, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.updatedAt}): super._();
