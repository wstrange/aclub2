...
_Event _$EventFromJson(Map<String, dynamic> json) => _Event(
  ...
  location: _eventLocationFromJson(json['location']),
  carpoolOption: _carpoolOptionFromJson(json['carpoolOption']),
...
Map<String, dynamic> _$EventToJson(_Event instance) => <String, dynamic>{
  ...
  'location': _eventLocationToJson(instance.location),
  'carpoolOption': _carpoolOptionToJson(instance.carpoolOption),
