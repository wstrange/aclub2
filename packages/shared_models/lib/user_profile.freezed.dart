...
/// and are stored on each [SectionMember] document.
 bool get isAdmin; bool get complatedProfile; bool get signedWaiver;/// FCM registration tokens for this user's devices.
///
...
int get hashCode {
  final _this = this as UserProfile;
  return Object.hash(runtimeType,_this.id,_this.firstName,_this.lastName,_this.email,_this.phone,_this.emergencyContactName,_this.emergencyContactPhone,_this.emergencyContactRelation,_this.medicalConditions,const DeepCollectionEquality().hash(_this.certifications),_this.defaultSectionId,_this.isAdmin,_this.complatedProfile,_this.signedWaiver,const DeepCollectionEquality().hash(_this.fcmTokens),_this.notificationPreferences,_this.createdAt,_this.updatedAt);
}

@override
String toString() {
  final _this = this as UserProfile;
  return 'UserProfile(id: ${_this.id}, firstName: ${_this.firstName}, lastName: ${_this.lastName}, email: ${_this.email}, phone: ${_this.phone}, emergencyContactName: ${_this.emergencyContactName}, emergencyContactPhone: ${_this.emergencyContactPhone}, emergencyContactRelation: ${_this.emergencyContactRelation}, medicalConditions: ${_this.medicalConditions}, certifications: ${_this.certifications}, defaultSectionId: ${_this.defaultSectionId}, isAdmin: ${_this.isAdmin}, complatedProfile: ${_this.complatedProfile}, signedWaiver: ${_this.signedWaiver}, fcmTokens: ${_this.fcmTokens}, notificationPreferences: ${_this.notificationPreferences}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt})';
}
